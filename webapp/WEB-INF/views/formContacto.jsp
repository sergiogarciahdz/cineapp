...
<html lang="en">
   <head>
      ...
      <title>Formulario de Contacto</title>
		...
		<spring:url value="/contacto" var="urlRoot"></spring:url>
	...
	<jsp:include page="includes/navbar.jsp"></jsp:include>
      ...
      <div class="container theme-showcase" role="main">
		...
		${ contacto }
         ...
         <form:form class="form-horizontal" action="${ urlRoot }" method="POST" modelAttribute="contacto">
            ...
            <div class="form-group">
               ...
               <div class="col-sm-10">
                  <label><form:radiobutton path="raiting" value="1" />Muy Mala</label>
                  <label><form:radiobutton path="raiting" value="2" />Mala</label>
                  <label><form:radiobutton path="raiting" value="3" />Regular</label>
                  <label><form:radiobutton path="raiting" value="4" />Buena</label>
                  <label><form:radiobutton path="raiting" value="5" />Muy Buena</label>
               </div>
            </div>

            <div class="form-group">
               <label class="col-sm-2 control-label">Te gustarÃ­a recibir notificaciones de:</label>
               <div class="col-sm-10">
               	<form:checkboxes items="${ tipoNotificacion }" path="notificaciones"/>
               </div>
            </div>
