...
<body>
	...
	<jsp:include page="../includes/navbar.jsp"></jsp:include>
		...
		<form:form action="${ urlRoot }/save" method="POST" modelAttribute="horario">
				<div class="row">         
					<div class="col-sm-3">
						<div class="form-group">
							<label for="idPelicula" class="control-label">Pelicula</label>              
							<form:select path="pelicula.id" class="form-control" items="${ peliculas }" itemValue="id" itemLabel="titulo" />        
						</div> 
					</div>
				</div>
				<div class="row"> 
