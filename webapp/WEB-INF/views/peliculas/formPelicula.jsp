...
<body>
	...
	<div class="container theme-showcase" role="main">
		...
		<form:form action="${ urlRoot }/save" method="POST" enctype="multipart/form-data" modelAttribute="pelicula">
				...
				<div class="col-sm-3">
					<div class="form-group">
						...
						<form:input type="text"
							class="form-control" path="duracion" id="duracion"
							required="required" />
					</div>
				</div>
				<div class="col-sm-3">
			...
			<div class="row">
				<div class="col-sm-3">
					<div class="form-group">
						...
						<form:input type="text" class="form-control" path="detalle.director"
							id="director" required="required" />
					</div>
				</div>
				<div class="col-sm-3">
					<div class="form-group">
						<label for="actores">Actores</label>
						<form:input type="text" class="form-control" path="detalle.actores"
							id="actores" required="required" />
					</div>
				</div>
				...
				<div class="col-sm-6">
					<div class="form-group">
						...
						<form:input type="text" class="form-control" path="detalle.trailer"
			...
			<div class="row">
				<div class="col-sm-6">
					<div class="form-group">
						...
						<form:textarea class="form-control" rows="5" path="detalle.sinopsis"
